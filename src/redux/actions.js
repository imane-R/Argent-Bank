...
export const loginRequest = (email,password) => {
	return(dispatch) => {
		service.post('user/login',{ email, password }) 
		.then((res) => {
...
export const userInfo = () => {
	return(dispatch) => {
		service.post('user/profile',{},{ headers:{ Authorization: `Bearer`+ localStorage.getItem('token') }})
		.then((res) => {
 ...
 */
 export const changeUserInfo = (firstName,lastName) => {
	return(dispatch) => {
		service.put('user/profile',{firstName,lastName},{ headers:{ Authorization: `Bearer`+ localStorage.getItem('token') }})
		.then(() => {
